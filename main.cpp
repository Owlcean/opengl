...
int main()
{
	...
	*/
	...
	Model ourModel("resources/model/nano/nanosuit.obj");
	Shader nanoShader("resources/shader/nano.vs", "resources/shader/nano.fs");
	Shader lightingShader("resources/shader/lighting_maps.vs", "resources/shader/lighting_maps.fs");
	Shader lightCubeShader("resources/shader/light_cube.vs", "resources/shader/light_cube.fs");
	...
	unsigned int diffuseMap = loadTexture("resources/pic/container2.png",false);
	unsigned int diffuseMap_gamma = loadTexture("resources/pic/container2.png", true);
	unsigned int specularMap = loadTexture("resources/pic/container2_specular.png", false);
	lightingShader.use();
